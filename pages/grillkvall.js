  ...
  return (
    ...
    <div className="container">
      ...
      <Query query={query} id={null}>
        {({ data: { grillkvall: { data: { attributes: { header, header_image: { data: { attributes: { url } } }, text_on_header_image, page_content } } }, navigation: { data: { attributes: { navigation_element } } } } }) => {
          return (
            <div>
